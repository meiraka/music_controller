...
class Connection(wx.BoxSizer):
    def __init__(self, parent, client):
        ...
        self.host = wx.TextCtrl(parent, -1, style=wx.TE_PROCESS_ENTER)
        self.host.SetFocus()
        self.port_label = wx.StaticText(parent, -1, _(u'Port')+':')
        self.port = wx.TextCtrl(parent, -1, style=wx.TE_PROCESS_ENTER)
        self.use_password = wx.CheckBox(parent, -1, _(u'Password')+':')
        self.password = wx.TextCtrl(parent, -1, style=wx.TE_PROCESS_ENTER)
        ...
        self.box.Bind(wx.EVT_LISTBOX_DCLICK, self.OnConnect)
        self.host.Bind(wx.EVT_TEXT_ENTER, self.OnConnect)
        self.port.Bind(wx.EVT_TEXT_ENTER, self.OnConnect)
