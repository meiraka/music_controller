...
class Info(wx.Panel):
	def __init__(self,parent,client,debug=False):
		...
		self.sizer.Add(self.artwork,(0,0),(1,3))
		self.sizer.Add(self.title,(1,1))
		self.sizer.Add(self.artist,(2,1))
		self.sizer.Add(self.album,(3,1))
	...
	def __update_image(self):
		if self.__image_path and not self.__lock:
			...
			iw,ih = image.GetSize()
			image.Rescale(w,ih/iw*w,quality=wx.IMAGE_QUALITY_HIGH)
