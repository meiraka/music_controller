...
import setuptools
import re
from music_controller import version
...
def test():
    sys.path.append(os.path.abspath('music_controller/core/'))
...
class BuildInfo(object):
    ...
    def generate_build_info(self):
        ...
        print build_info
        f = open('music_controller/buildinfo.py','w')
        f.write(build_info)

    def delete_build_info(self):
        os.remove('music_controller/buildinfo.py')
        return False
...
class Setup(object):
    def __init__(self):
        ...
        """
        self.setup_args = {}
        self.setup_args['packages'] = ['music_controller', 'music_controller.core']
        self.setup_args['data_files'] = [
                        ('share/applications',['unix/music-controller.desktop']),
                        ]
        self.setup_args['entry_points'] = {
            'gui_scripts': ['music-controller = music_controller:run']}
